...
function instalazioBotoia(izena, calendarId, ikonoa = "📅") {
  return `
    <button class="aukera-botoia" onclick="instalazioCalendarIkusi('${calendarId}', '${izena.replace("'", "\\'")}')">
      <span class="aukera-ikonoa">${ikonoa}</span>
      <span>${babestu(izena)}</span>
      <span class="aukera-gezi">›</span>
    </button>
  `;
}

function instalazioCalendarIkusi(calendarId, izena) {
  const src = `https://calendar.google.com/calendar/embed?src=${encodeURIComponent(calendarId)}&ctz=Europe%2FMadrid&mode=AGENDA`;
  document.getElementById("edukia").innerHTML = `
    <button class="atzera-botoia" onclick="kokalekuakIkusi()">← Instalazioak</button>
    <div class="orrialde-goiburua"><h2>${babestu(izena)}</h2></div>
    <article class="txartela" style="padding:0; overflow:hidden;">
      <iframe
        src="${src}"
        title="${babestu(izena)}"
...
function kokalekuakIkusi() {
  document.getElementById("edukia").innerHTML = `
    <button class="atzera-botoia" onclick="erakutsiAtala('gehiago')">← Gehiago</button>
    <div class="orrialde-goiburua">
      <h2>Instalazioak</h2>
      <p>Aukeratu taldea bere instalazioen egutegia ikusteko.</p>
    </div>

    <article class="txartela">
      <h3>LH1 · LH2 · LH3 · LH4</h3>
      <div class="aukera-zerrenda">
        ${instalazioBotoia("Talde berdea", "b28451ff946a9b6333f1cc054eb8d263feec1b96c8440ca9ce4414e669d854c2@group.calendar.google.com", "🟢")}
        ${instalazioBotoia("Talde laranja", "c34a07e7f122238624391124241a4808282ada68834081a193f9dc26ab7c9973@group.calendar.google.com", "🟠")}
      </div>
    </article>
    ...
    <article class="txartela">
      <h3>LH5</h3>
      <div class="aukera-zerrenda">
        ${instalazioBotoia("Talde arrosa", "160dc75ac739d6e5355f3e19e19e58ce0908538750b43ce8fd4654e41a0d7c08@group.calendar.google.com", "🩷")}
        ${instalazioBotoia("Talde horia", "e7ab91b58c9831564d3376108b910dea500445f0af259fe40dd0974fde95e421@group.calendar.google.com", "🟡")}
        ${instalazioBotoia("Talde morea", "a2f0cbcc2d270daf898d9e7d090ef99e537a90b9ec774a1c317860b3c48dd2c7@group.calendar.google.com", "🟣")}
      </div>
    </article>
    ...
    <article class="txartela">
      <h3>LH6</h3>
      <div class="aukera-zerrenda">
        ${instalazioBotoia("LH6 instalazioak", "41f5c31499b3ad6d31646515b6c4c4f56a589c93bf1d9b3a0e200a033584bfc5@group.calendar.google.com", "🔵")}
      </div>
    </article>

    <article class="txartela">
      <h3>Psikomotrizitatea</h3>
      <div class="irudi-blokea">
        <h4>HH3 txandak</h4>
      ...
      <div class="irudi-blokea" style="margin-top:18px;">
        <h4>HH5 txandak</h4>
